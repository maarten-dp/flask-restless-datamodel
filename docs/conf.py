...
project = u"flask-restless-datamodel"
author = "GEM"
...
extlinks = {
    # 'issue': ('https://github.com/maarten-dp/flask-restless-datamodel/issues
    # 'pr': ('https://github.com/maarten-dp/flask-restless-datamodel/pulls
}
